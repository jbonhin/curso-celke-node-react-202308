// Normalizar o código, ajuda evitar gambiarras
'use strict';

// Permite trabalhar com o sistema de arquivos de computador
const fs = require('fs');

// Fornece utilitários para trabalhar com caminhos de arquivos e diretórios
const path = require('path');

// Sequelize é um ORM para Node.js, que tem suporte para vários bancos de dados
